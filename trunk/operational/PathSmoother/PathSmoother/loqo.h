...
#define	LOQO_UNSET  0
#define	LOQO_PRIMAL 1
#define	LOQO_DUAL   2

#define	LOQO_MAX(x,y)  ((x) > (y) ? (x) : (y))
#define	LOQO_MIN(x,y)  ((x) > (y) ? (y) : (x))
#define	LOQO_ABS(x)	  ((x) > 0   ? (x) : -(x))
#define	LOQO_SGN(x)	  ((x) > 0   ? (1.0) : (-1.0))

#define LOQO_FINITE   0x1
#define LOQO_INFINITE 0x2
#define LOQO_UNCONST  0x4
#define LOQO_FROW     0x8
#define LOQO_FREEVAR   0x1
#define LOQO_BDD_BELOW 0x2
#define LOQO_BDD_ABOVE 0x4
#define LOQO_BOUNDED   0x8
