...
{
	/// <summary>
	/// A parking spot waypoint
	/// </summary>
	[Serializable]
	public class ArbiterParkingSpotWaypoint : IArbiterWaypoint, IGenericWaypoint, INavigableNode, IDisplayObject, INetworkObject
	{
		...
		/// <summary>
		/// The spot this waypoint is a part of
		/// </summary>
		...
		/// Id of the waypoint
		/// </summary>
		public ArbiterParkingSpotWaypointId WaypointId;

		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="position"></param>
		public ArbiterParkingSpotWaypoint(Coordinates position)
		{
		...
		{
			return DrawingUtility.DrawArbiterParkingSpotWaypoint;
		}
		...
		{
			// make sure type same
			if (obj is ArbiterParkingSpotWaypoint)
			{
				return ((ArbiterParkingSpotWaypoint)obj).WaypointId.Equals(this.WaypointId);
			}
		...
		public double ExtraTimeCost
		{
			get
			{
				return NavigationPenalties.ParkingSpotWaypoint + NavigationPenalties.ZoneWaypoint;
			}
		}
