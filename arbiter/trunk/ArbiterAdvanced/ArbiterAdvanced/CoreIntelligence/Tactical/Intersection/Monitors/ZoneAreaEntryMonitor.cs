...
{
	/// <summary>
	/// entry monitor to monitor the entry i nto a zone
	/// </summary>
	public class ZoneAreaEntryMonitor : IDominantMonitor, IEntryAreaMonitor
	{
		/// <summary>
		...
		public bool ExcessiveWaiting
		{
			get
			{
				return this.failedTimer.IsRunning && (failedTimer.ElapsedMilliseconds / 1000.0) > 30.0;
			}
		}
